...
def denoiser_train(denoiser, lr):
    with load_data(filepath='./data/img_clean_pats.npy') as data:
        ...
        eval_files = glob('./data/test/{}/*.png'.format(args.eval_set)) + glob('./data/test/{}/*.jpg'.format(args.eval_set))
...
def denoiser_test(denoiser):
    test_files = glob('./data/test/{}/*.png'.format(args.test_set)) + glob('./data/test/{}/*.jpg'.format(args.test_set))
